...
var demoTenants = []struct {
	...
	// The names are the Social Democratic Youth Union of Mongolia's: this repository is the
	...
	{demoTenantID, "demo", "Социал Демократ Монголын Залуучуудын Холбоо", demoRoleID, []string{"ai"}},
	...
	// longer do.
	{secondTenantID, "demo-branch", "СДМЗХ — Улаанбаатар хотын салбар зөвлөл", secondRoleID, []string{"ai"}},
}

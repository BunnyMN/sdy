...
- Гишүүний PWA, Events, Profile-д байгууллагын нэртэй тусдаа shell,
  240px sidebar, touch доод цэс, буцах холбоос, route title/focus нэмэв.
- Нүүр, хүсэлтүүд, ирц/оноо, хураамж, удирдлагын дэлгэц болон нэвтрэх
  картын зай, бичиг, булан, light/dark өнгө, touch target-ийг нэгтгэв.
- Шилжилтийн шийдвэр ба цуцлалт нягтлах цонхтой; мөнгө `25,000₮`,
  огноо UTC+8-аар ижил форматтай. [Дизайны тайлбар](docs/SDY_DESIGN_REVIEW.md).

### Added — Байгууллагын админ батлах шилжилт (2026-09-11)

- Гишүүн PWA-аас очих салбар, шалтгаанаа сонгож шилжих хүсэлт илгээнэ;
  зөвхөн очих байгууллагын идэвхтэй admin батлах эсвэл татгалзана.
- Хүлээгдэж байхад хуучин харьяалал хэвээр; гишүүн хүсэлтээ цуцалж болно.
  Батлахад хуучин харьяалал дуусаж, шинэ салбарт зөвхөн user эрх олгоно.
  Хуучин ирц, оноо, хураамжийн түүх хадгалагдана; дахин нэвтрэх шаардлагатай.
- Core migration 111: RLS бүхий хүсэлтийн бүртгэл, actor/tenant шалгадаг
  хязгаарлагдсан SQL үйлдлүүд, шийдвэрийн audit. Manager энгийн элсэлтийн
  хүсэлтээр өөр салбарын гишүүнийг давхар элсүүлэх боломжгүй.
- Шилжилтийн API, RLS, өрсөлдсөн батлах/цуцлах үйлдэл, төлсөн хураамжийн
  түүх болон утасны дэлгэцийн тест нэмэв.

### Fixed — SDY элсэлт, PWA, Membership 1.0.1 (2026-09-11)

- Гишүүнчлэлийг идэвхгүй болгомогц тухайн байгууллагын хуучин session
  ажиллахгүй. Олон байгууллага сонгосон session-ийн RLS хүрээг хүсэлт бүрд
  идэвхтэй гишүүнчлэл, ажиллаж буй байгууллагаар дахин хязгаарлана.
- Идэвхгүй гишүүнд шинэ сарын хураамж ногдуулахгүй; өмнөх ногдуулалт,
  төлөлтийн түүхийг хадгална.
- Browser storage хаалттай үед PWA суулгах, суулгалтын саналыг хаах үйлдэл
  алдаа өгөхгүй. Суулгах санал байгууллагын брэндийн icon-ыг ашиглана.
- Бодит утасны eID/QR хүлээн авалт, салбарын томилгоо, хураамж ба онооны
  дүрмийг бүртгэх [туршилтын заавар](docs/SDY_PILOT.md) нэмэв.
...
- Membership 1.0.0: сарын ногдуулалт, банкны шилжүүлгийн мэдээлэл,
  санхүүгийн баталгаажуулалт, хэсэгчилсэн төлөлт, залруулга, чөлөөлөлт.
...
### Fixed — SDY Events 1.0.1 (2026-09-10)

- Нэг арга хэмжээний бүртгэл, ирц, багтаамжийн өөрчлөлтүүд parent row lock
  бүхий transaction ашиглана. Зэрэг ирсэн бүртгэл болон менежерийн өөрчлөлт
  хүний дээд тоог хэтрүүлэхгүй; багтаамжийг бүртгэлтэй хүний тооноос багасгахгүй.
- Гишүүн зөвхөн товлогдсон арга хэмжээний `registered` бүртгэлээ цуцална.
  Дууссан/цуцлагдсан арга хэмжээ, тэмдэглэгдсэн ирцийн түүх хадгалагдана.
- Events жагсаалтын DB мөр унших алдааг амжилттай дутуу хариунаас ялгана.
  Формын label-уудыг input-тай холбосон.
- Reports-ийн дундын дэлгэцийг route файлаас салгаж Webpack production
  build-ийн `PageProps` TypeScript алдааг зассан.
- Үл мэдэгдэх Server Action-д root layout-гүй 404 зурагдах үед i18n provider
  байхгүйгээс нэмэлт алдаа үүсдэгийг зассан; серверийн лог дээр илэрсэн тохиолдол.
- PostgreSQL/RLS, зэрэг хүсэлт, нэвтрэлтээс элсэлт/суулгалт/ирц хүртэлх
  API урсгал, Chromium дээрх Events урсгалын тестүүд нэмсэн.
- Production контейнерийн логийг тус бүр 10 MB × 5 файлаар хязгаарласан.
  Backup скрипт шинээр үүсэх нөөц файлуудыг зөвхөн эзэмшигч унших эрхтэй болгоно.

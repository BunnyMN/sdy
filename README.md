...
**Социал Демократ Монголын Залуучуудын Холбооны (СДМЗХ) гишүүд, салбар зөвлөл, ажлын албаны
...
асаана. Брэнд нь compose-ийн default-оор СДМЗХ-ных; өөр нэрээр асаахын тулд
...
| Нууц үг | `Password123!` |
| Tenant | `Социал Демократ Монголын Залуучуудын Холбоо` (`demo`), хоёр дахь нь `СДМЗХ — Улаанбаатар хотын салбар зөвлөл` (`demo-branch`) |
